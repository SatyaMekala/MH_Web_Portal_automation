...
When I wait `PT10S` with `PT05S` polling until element located `By.xpath(//a[contains(text(),'Configure two-step verification')])` becomes VISIBLE
When I click on element located `By.xpath(//a[contains(text(),'Configure two-step verification')])`

!-- When I click on all elements located `By.xpath(//a[contains(text(),'Configure two-step verification')])`
...
!-- When I click on element located `By.xpath(//input[@name='password'])`
